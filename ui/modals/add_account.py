...
class AddAccountModal(Modal):
    def __init__(self, master, company_id, on_success, **kwargs):
        super().__init__(master, title="New Account", width=450, height=550, **kwargs)
    ...
    def _build_ui(self):
        ...
        self.name_entry  = self._field("Name",        "e.g. Main Checking")
        self.bal_entry   = self._field("Balance",     "0.00",    value="0.00")
        ...
        self.type_var = ctk.StringVar(value="Bank")
        ...
        self.curr_var = ctk.StringVar(value="USD")
        ...
        ctk.CTkButton(footer, text="Create Account \u2713", fg_color=THEME["green"],
    ...
    def _submit(self):
        try:
            ...
            create_account(data)
            Toast(self.master, "Account created", type="success")
